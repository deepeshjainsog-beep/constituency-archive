...
(async function () {
  ...
  const PARTY = {
    ...
    DMK:   { full: "Dravida Munnetra Kazhagam",       c: "oklch(0.55 0.19 15)"  },
    BJD:   { full: "Biju Janata Dal",                  c: "oklch(0.58 0.14 130)" },
    RJD:   { full: "Rashtriya Janata Dal",             c: "oklch(0.55 0.16 145)" },
    JMM:   { full: "Jharkhand Mukti Morcha",           c: "oklch(0.52 0.15 160)" },
    "CPI(ML)(L)": { full: "CPI (Marxist-Leninist) (Liberation)", c: "oklch(0.50 0.18 25)" },
    "CPI(ML)": { full: "CPI (Marxist-Leninist)",       c: "oklch(0.52 0.17 25)" },
    JVM:   { full: "Jharkhand Vikas Morcha (P)",       c: "oklch(0.60 0.12 175)" },
    LJPRV: { full: "Lok Janshakti Party (Ram Vilas)",  c: "oklch(0.62 0.14 330)" },
    AJSUP: { full: "All Jharkhand Students Union",     c: "oklch(0.66 0.13 100)" },
    HAMS:  { full: "Hindustani Awam Morcha (S)",       c: "oklch(0.58 0.11 50)"  },
    JCC:   { full: "Janta Congress Chhattisgarh (J)",  c: "oklch(0.64 0.11 250)" },
    JCCJ:  { full: "Janta Congress Chhattisgarh (J)",  c: "oklch(0.64 0.11 250)" },
    RLM:   { full: "Rashtriya Lok Morcha",             c: "oklch(0.66 0.10 65)"  },
    VIP:   { full: "Vikassheel Insaan Party",          c: "oklch(0.60 0.12 285)" },
    RLSP:  { full: "Rashtriya Lok Samta Party",        c: "oklch(0.68 0.11 70)"  },
    OGP:   { full: "Orissa Gana Parishad",             c: "oklch(0.62 0.10 140)" },
    JKP:   { full: "Jharkhand Party",                  c: "oklch(0.56 0.10 170)" },
    BLSP:  { full: "Bihar Lok Samta Party",            c: "oklch(0.64 0.09 60)"  },
    TDP:   { full: "Telugu Desam Party",               c: "oklch(0.72 0.14 70)"  },
    UKKD:  { full: "Uttarakhand Kranti Dal",           c: "oklch(0.58 0.13 110)" },
    UKDP:  { full: "Uttarakhand Kranti Dal (P)",       c: "oklch(0.62 0.11 115)" },
    HVC:   { full: "Himachal Lokhit Party / Vikas Congress", c: "oklch(0.64 0.12 320)" },
    HLP:   { full: "Himachal Lokhit Party",            c: "oklch(0.66 0.11 325)" },
    LMHP:  { full: "Lok Morcha Himachal Pradesh",      c: "oklch(0.60 0.09 345)" },
    LJNSP: { full: "Lok Jan Shakti Party",             c: "oklch(0.62 0.13 330)" },
    YSRCP: { full: "YSR Congress Party",               c: "oklch(0.56 0.14 215)" },
    TRS:   { full: "Telangana Rashtra Samithi",        c: "oklch(0.62 0.15 140)" },
    BRS:   { full: "Bharat Rashtra Samithi",           c: "oklch(0.62 0.15 140)" },
    AIMIM: { full: "All India Majlis-e-Ittehadul Muslimeen", c: "oklch(0.48 0.13 160)" },
    MIM:   { full: "Majlis-e-Ittehadul Muslimeen",     c: "oklch(0.48 0.13 160)" },
    JnP:   { full: "Jana Sena Party",                  c: "oklch(0.66 0.16 40)"  },
    PRAP:  { full: "Praja Rajyam Party",               c: "oklch(0.60 0.14 330)" },
    MBT:   { full: "Majlis Bachao Tehreek",            c: "oklch(0.52 0.11 170)" },
    ICJ:   { full: "Indian Congress (J)",              c: "oklch(0.70 0.09 238)" },
    NPT:   { full: "Navodayam Party",                  c: "oklch(0.64 0.10 300)" },
    LSP:   { full: "Lok Satta Party",                  c: "oklch(0.60 0.12 190)" },
    JKNC:  { full: "Jammu & Kashmir National Conference", c: "oklch(0.54 0.16 32)" },
    JKPDP: { full: "Jammu & Kashmir Peoples Democratic Party", c: "oklch(0.56 0.14 165)" },
    JKNPP: { full: "Jammu & Kashmir National Panthers Party", c: "oklch(0.60 0.12 305)" },
    JKPC:  { full: "Jammu & Kashmir Peoples Conference", c: "oklch(0.62 0.13 210)" },
    JKAL:  { full: "Jammu & Kashmir Awami League",     c: "oklch(0.58 0.11 180)" },
    JKDPN: { full: "Jammu & Kashmir Democratic Party Nationalist", c: "oklch(0.64 0.10 270)" },
    PDF:   { full: "Peoples Democratic Front",         c: "oklch(0.60 0.12 155)" },
    JKPDF: { full: "Jammu & Kashmir Peoples Democratic Front", c: "oklch(0.62 0.11 150)" },
    JPP:   { full: "Jammu Praja Parishad",             c: "oklch(0.66 0.12 60)"  },
    "AIIC(T)": { full: "All India Indira Congress (Tiwari)", c: "oklch(0.70 0.09 235)" },
    DM:    { full: "Democratic Movement",              c: "oklch(0.60 0.08 200)" },
    AIADMK:{ full: "All India Anna DMK",              c: "oklch(0.60 0.15 145)" },
    TVK:   { full: "Tamilaga Vettri Kazhagam",        c: "oklch(0.72 0.15 85)"  },
    PMK:   { full: "Pattali Makkal Katchi",           c: "oklch(0.80 0.14 100)" },
    DMDK:  { full: "Desiya Murpokku Dravida Kazhagam",c: "oklch(0.58 0.14 350)" },
    MDMK:  { full: "Marumalarchi DMK",                c: "oklch(0.62 0.12 170)" },
    VCK:   { full: "Viduthalai Chiruthaigal Katchi",  c: "oklch(0.50 0.14 260)" },
    "TMC(M)": { full: "Tamil Maanila Congress (M)",   c: "oklch(0.72 0.10 215)" },
    TMK:   { full: "Tamil Maanila Congress",          c: "oklch(0.70 0.10 210)" },
    IUML:  { full: "Indian Union Muslim League",      c: "oklch(0.54 0.12 160)" },
    "ADK(JL)": { full: "AIADMK (Jayalalithaa)",       c: "oklch(0.64 0.14 140)" },
    "ADK(JR)": { full: "AIADMK (Janaki Ramachandran)",c: "oklch(0.68 0.12 135)" },
    MADMK: { full: "MGR Anna DMK",                    c: "oklch(0.66 0.11 150)" },
    AMMKMNKZ: { full: "Amma Makkal Munnetra Kazhagam",c: "oklch(0.62 0.13 120)" },
    GKC:   { full: "Gandhi Kamaraj Congress",         c: "oklch(0.68 0.09 235)" },
    MMKA:  { full: "Makkal Munnetra Kazhagam",        c: "oklch(0.60 0.10 185)" },
    PT:    { full: "Puthiya Tamilagam",               c: "oklch(0.56 0.12 275)" },
    AKD:   { full: "Anaithinthiya Kamarajar Dravida", c: "oklch(0.66 0.08 250)" },
    "ICS(SCS)": { full: "Indian Congress (Socialist)", c: "oklch(0.68 0.10 240)" },
    GGP:   { full: "Gondwana Gantantra Party",        c: "oklch(0.55 0.13 145)" },
    BJSH:  { full: "Bharatiya Jan Shakti",            c: "oklch(0.68 0.14 40)"  },
    RSMD:  { full: "Rashtriya Samanta Dal",           c: "oklch(0.60 0.10 350)" },
    KSM:   { full: "Kisan Mazdoor Party",             c: "oklch(0.64 0.11 130)" },
    ICS:   { full: "Indian Congress (Socialist)",     c: "oklch(0.68 0.10 240)" },
    RPI:   { full: "Republican Party of India",       c: "oklch(0.52 0.13 300)" },
    "RPI(K)": { full: "Republican Party of India (K)", c: "oklch(0.56 0.12 305)" },
    RPK:   { full: "Republican Party of India (K)",   c: "oklch(0.56 0.12 305)" },
    AJBP:  { full: "Akhil Jan Bharat Party",          c: "oklch(0.62 0.09 20)"  },
    BHRTADVSIP: { full: "Bharatiya Adivasi Party",    c: "oklch(0.58 0.12 160)" },
